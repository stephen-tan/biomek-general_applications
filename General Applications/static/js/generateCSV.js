...
var methodTitle = document.title.split(' ').join('_'); // replace spaces with underscores
...
startRun.on('click', function() {
    ...
    // Add the method name to the parametersArray
    parametersArray.push({key: "methodTitle", value: methodTitle});
...
downloadCSV.on('click', function() {
    ...
    // Create the filename based on the local datetime
    var filename = "GenApps_" + methodTitle + "_" + date + "_" + time + ".csv";
