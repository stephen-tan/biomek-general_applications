...
$(document).ready(function() {
    ...
    $('#sourceType, #destinationType').on('change', function() {
        ...
        if (sourceType == "96 Corning Deep Well 2.0mL" || destinationType == "96 Corning Deep Well 2.0mL"
            || sourceType == "1 Agilent Deep Reservoir 250mL") {
            if (sourceType == "96 Corning Deep Well 2.0mL") {
                $('#srcWellVolume input').val(2000);
            }
            else if (sourceType == "1 Agilent Deep Reservoir 250mL") {
                $('#srcWellVolume input').val(250000);
            }
            $('#tipType option').filter('[value="f20"], [value="s20"]').hide();
        }
        else if (sourceType == "1 Agilent Shallow Reservoir 80mL") {
            $('#srcWellVolume input').val(80000);
    ...
    $('#numStamps').on('change', function() {
        ...
        var methodName = document.title;
        console.log(methodName);

        var imageNumber = $('#numStamps option:selected').val();
        console.log(`${imageNumber} unique transfers`);

        if (methodName == "Stamp 96-to-96") {
            if (imageNumber == 5) {
                $('#stamp96to96image').attr('src', '../images/stamp96to96/5 Stamp - 96 to 96.png');
            }
            else if (imageNumber == 4) {
                $('#stamp96to96image').attr('src', '../images/stamp96to96/4 Stamp - 96 to 96.png');
            }
            else if (imageNumber == 3) {
                $('#stamp96to96image').attr('src', '../images/stamp96to96/3 Stamp - 96 to 96.png');
            }
            else if (imageNumber == 2) {
                $('#stamp96to96image').attr('src', '../images/stamp96to96/2 Stamp - 96 to 96.png');
            }
            else if (imageNumber == 1) {
                $('#stamp96to96image').attr('src', '../images/stamp96to96/1 Stamp - 96 to 96.png');
            }
        }
        else if (methodName == "Stamp Res-to-96") {
            if (imageNumber == 5) {
                $('#stampResto96image').attr('src', '../images/stampResto96/5 Stamp - Res to 96.png');
            }
            else if (imageNumber == 4) {
                $('#stampResto96image').attr('src', '../images/stampResto96/4 Stamp - Res to 96.png');
            }
            else if (imageNumber == 3) {
                $('#stampResto96image').attr('src', '../images/stampResto96/3 Stamp - Res to 96.png');
            }
            else if (imageNumber == 2) {
                $('#stampResto96image').attr('src', '../images/stampResto96/2 Stamp - Res to 96.png');
            }
            else if (imageNumber == 1) {
                $('#stampResto96image').attr('src', '../images/stampResto96/1 Stamp - Res to 96.png');
            }
        }
